...
function placeElementClickHandler(event) {
  if (currentElement) {
    ...
    // ? Get the size of the mood board element
    const moodBoardRect = moodBoardEl.getBoundingClientRect();

    // TODO: Explain what the following code does
    // ? Calculate the position of the element based on the mouse position and the position of the mood board
    ...
    // ? Check if the current element is an image or text and push the information to the tempStorageObject accordingly.
